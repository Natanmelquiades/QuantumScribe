...
- Rode `ruff check .`
- Rode `python -m compileall -q localwhisper main.py`
...
- AIOX CLI module: `.aiox-core/cli/`
- Application entrypoint: `main.py`
- Application package: `localwhisper/`
- Tests: `tests/`
- Docs: `docs/`
...
- `node .aiox-core/development/scripts/validate-filenames.js`
