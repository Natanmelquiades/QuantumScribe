...
for (const packageJsonPath of packageJsonCandidates) {
  try {
    ...
    // Try the next installation layout (project root or .aiox-core).
  }
}
...
// Allow the installed project-local CLI module to be executed directly while
// remaining importable by the package-level AIOX launcher.
